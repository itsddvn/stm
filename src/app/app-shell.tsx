    ...
    <div className="app-shell">
      ...
      <aside className="sidebar" aria-label="Primary navigation">
        ...
        <div className="sidebar-status">
          ...
          <div><strong>{fixtureRuntime ? "Deterministic simulation" : "Desktop runtime"}</strong><small>{fixtureRuntime ? "Desktop adapter-ready" : "Typed lifecycle adapter"}</small></div>
        </div>
      </aside>
