...
- Modify: `crates/stm-core/src/catalog/mod.rs` including both ten-count sites
- Modify: `crates/stm-core/src/application/service.rs` ten-count tests
...
- Modify: `crates/stm-core/src/lifecycle/evidence.rs` to compare tap/publisher provenance
...
- [x] Add typed recipe schema
- [x] Fix Orca and Oh My Pi sources
- [x] Add Codex Homebrew cask recipe
- [x] Detect Homebrew, Bun, npm/Node
- [x] Implement provider resolver
- [x] Replace ten-id recommended invariant

## Success Criteria

- [x] Catalog validation fails on shell/script fields.
- [x] Resolver never chooses Bun for a desktop app.
- [x] Existing npm-owned Codex stays npm-owned.
- [x] Clean macOS Automatic preference chooses Homebrew for Codex when brew exists or will be bootstrapped.
