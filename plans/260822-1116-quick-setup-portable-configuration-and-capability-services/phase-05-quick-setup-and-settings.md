...
- [x] First-launch Quick Setup
- [x] Recommendation checklist
- [x] Provider preference settings
- [x] Reviewed provider migration — Codex npm → Homebrew exact recipe
- [x] Fixture scenarios

## Success Criteria

- [x] A fixture clean-macOS run shows preselected defaults and one Start action.
- [x] Skip prevents automatic reopen.
- [x] Existing npm Codex row stays npm-owned until migration is reviewed.
- [x] Migration cannot uninstall the old copy before the new copy verifies.
