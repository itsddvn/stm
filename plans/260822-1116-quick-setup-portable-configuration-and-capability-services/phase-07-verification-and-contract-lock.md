...
- [ ] Clean-macOS fixture can install the default profile through one review in the running UI.
- [ ] Existing-owner and target-mismatch cases fail closed in tests and UI.
- [ ] Evergreen docs match shipped crates, not the old single-core layout.
