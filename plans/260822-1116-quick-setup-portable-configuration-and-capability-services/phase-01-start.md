...
- Current owners: `docs/system-architecture.md`, `crates/tools-manager-core/src/application/service.rs`, `crates/tools-manager-core/src/lifecycle/service.rs`, `src-tauri/src/lib.rs`.
...
- [x] Packaging is `tools-manager-core`, `tools-manager-runtime`, and `stm-desktop`.
