...
pub fn validate_inventory_fields(
...
pub fn validate_lifecycle_server(server: &McpServerRecord) -> Result<(), String> {
...
pub fn approved_server_for_endpoint(
    endpoint: &str,
    clients: &[McpClientName],
) -> Result<Option<McpServerRecord>, String> {
