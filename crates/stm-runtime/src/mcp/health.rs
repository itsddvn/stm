...
use crate::host::compile_mcp_stdio;
use stm_core::{
    domain::mcp::{
...
mod tests {
    ...
    fn approved_stdio_health_runs_only_initialize_against_the_bound_executable() {
        ...
        let identity = crate::host::RealHostExecutableResolver
        ...
        let server = stm_core::mcp::policy::approved_server(
            "filesystem",
            &["/tmp".into()],
            &[stm_core::domain::mcp::McpClientName::Codex],
        )
